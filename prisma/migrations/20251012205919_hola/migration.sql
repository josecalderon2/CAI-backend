...
-- CreateIndex
CREATE INDEX "PasswordResetToken_adminId_idx" ON "public"."PasswordResetToken"("adminId");

-- CreateIndex
CREATE INDEX "PasswordResetToken_orientadorId_idx" ON "public"."PasswordResetToken"("orientadorId");
...
-- AddForeignKey
ALTER TABLE "public"."Asignatura" ADD CONSTRAINT "Asignatura_id_curso_fkey" FOREIGN KEY ("id_curso") REFERENCES "public"."Curso"("id_curso") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."PasswordResetToken" ADD CONSTRAINT "PasswordResetToken_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "public"."administrativos"("id_administrativo") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."PasswordResetToken" ADD CONSTRAINT "PasswordResetToken_orientadorId_fkey" FOREIGN KEY ("orientadorId") REFERENCES "public"."orientadores"("id_orientador") ON DELETE CASCADE ON UPDATE CASCADE;
